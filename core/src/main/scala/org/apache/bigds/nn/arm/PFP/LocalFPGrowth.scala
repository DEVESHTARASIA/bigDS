package org.apache.spark.mllib.bigds.arm.PFP

import scala.collection.mutable.ArrayBuffer
import scala.collection.mutable.HashMap

/**
 * File: LocalFPGrowth.scala
...
object LocalFPGrowth{
  def apply(records: Array[Array[String]], minSupport: Long): ArrayBuffer[(String, Long)] = {
    ...
    //Create FPTree.
    val fptree = new LocalFPGrowth(new ArrayBuffer[(String, Long)]())
...
class LocalFPGrowth(var patterns: ArrayBuffer[(String, Long)]){
