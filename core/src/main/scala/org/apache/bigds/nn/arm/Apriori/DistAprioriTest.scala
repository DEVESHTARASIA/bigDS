package org.apache.spark.mllib.bigds.arm.Apriori
...
object DistAprioriTest {
  def main(args: Array[String]): Unit = {
    ...
    val data = sc.textFile("hdfs://sr471:54311/user/clin/fpgrowth/input/" + fileName, 128)
